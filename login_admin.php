...
if (isset($_SESSION["username"])) {
  header("Location:{$location}/Admin/show_admin.php");
}
session_unset();
session_destroy();
// else{
//   if(isset($_SESSION["username"]) && $_SESSION["role"]==0){
//   header("Location:http://localhost/Projects%20BCA/Computer%20_Shop%20SEM%205/User/start.php");
//   }
//}
...
<body>
  <div class="container">
    <form action="<?php $_SERVER['PHP_SELF']; ?>" id="login" method="post">
      ...
      <br>
      <p> <a style='text-decoration:"none;"' href="login_user.php">User Login</a></p>
      <br>
